...
import {Avatar, Button, Paper, Typography, Grid, Container, Snackbar} from '@material-ui/core'
...
const AuthenticationPage = () => {
    ...
    const handleSwitchMode = () => setIsSignUp((prevValue) => !prevValue);
        ...
        <form className={classes.form} onSubmit={handleAuthSubmit}>
            ...
            <Grid container justifyContent="flex-end">
                ...
                <Button onClick={handleSwitchMode} className={classes.submit}>
                    Already have an account ? {isSignUp ? 'Sign In' : 'Sign Up'}
                </Button>
                </Grid>
            </Grid>
        </form>
